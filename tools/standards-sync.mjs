...
import { syncAxeRuleSeverities } from './axe-sync.mjs';
...
export async function syncStandards({
  ...
  axeOutput = 'generated/axe-rule-severities.json',
  ...
  const [act, aria, axe, language, wcag, html, sources] = await Promise.all([
    syncActRules(actOutput),
    syncAriaRegistry(ariaOutput),
    syncAxeRuleSeverities(axeOutput),
