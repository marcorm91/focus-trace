...
| **PDF / TXT / Markdown / JSON** | Current report or Memory baseline | Exports the applicable evidence and auditor notes without silently rerunning a full DOM collection. Individual page/component PDFs include a compact linked section index, using the multipage index's regular typography, dotted leaders and spacing without solid row separators. | Shareable artifacts. |
