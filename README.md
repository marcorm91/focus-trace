...
| Dynamic states | Static analysis does not force inactive hover, pressed, checked or focus states. During Trace, FocusTrace can review text contrast for trusted interactive states that are actually observed, but it does not exercise every possible state or application path. |
