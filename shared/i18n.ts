...
const EXTRA_COPY_ES: Record<string, { title: string; description: string }> = {
  'FT-WCAG-017': {"title": "La celda de datos necesita una relación válida con sus encabezados", "description": "La celda de datos no tiene una asociación válida con encabezados dentro de la tabla. Revisa las relaciones nativas y los atributos headers, scope y los roles ARIA aplicables."},
  'FT-WCAG-018': {"title": "El objeto incrustado necesita una alternativa accesible no vacía", "description": "El objeto muestra contenido no textual sin una alternativa accesible utilizable. Proporciona un nombre accesible no vacío o márcalo como presentación solo si es decorativo."},
  'FT-WCAG-019': {"title": "El marco incrustado necesita un nombre accesible no vacío", "description": "El marco expuesto carece de nombre accesible, por lo que los usuarios de tecnologías de asistencia no pueden identificar el propósito del contexto de navegación incrustado."},
  'FT-WCAG-020': {"title": "El marco con contenido enfocable debe ser accesible mediante teclado", "description": "El marco está excluido de la navegación secuencial con teclado, aunque su documento del mismo origen contiene al menos un descendiente enfocable secuencialmente."},
  'FT-WCAG-021': {"title": "La configuración del viewport debe permitir ampliar al 200 %", "description": "Las directivas del viewport limitan la ampliación al 200 % evaluada. Revisa user-scalable y maximum-scale y permite que el usuario amplíe el contenido."},
  'FT-WCAG-022': {"title": "La actualización automática diferida no debe imponer un límite de tiempo breve", "description": "La primera directiva meta refresh interpretable impone una actualización o redirección automática diferida dentro del intervalo evaluado para WCAG 2.2.1."},
  'FT-REVIEW-030': {"title": "Revisa la ausencia de un encabezado de nivel uno", "description": "No se ha observado un encabezado de nivel uno en la página. Revisa si la jerarquía comunica su tema principal; la ausencia por sí sola no demuestra un incumplimiento WCAG."},
  'FT-REVIEW-031': {"title": "Revisa el encabezado vacío", "description": "El encabezado expuesto no comunica un tema mediante un nombre accesible. Comprueba su contenido renderizado y las alternativas antes de determinar su impacto."},
  'FT-REVIEW-032': {"title": "Revisa el párrafo con apariencia de encabezado", "description": "Se ha observado un párrafo con estilo visual de encabezado. Confirma si introduce una sección que deba representarse mediante un encabezado semántico."},
  'FT-REVIEW-033': {"title": "Revisa la ubicación de los landmarks de nivel de página", "description": "Se han observado landmarks de nivel de página anidados en otros landmarks. Revisa su contexto y la estructura prevista; esta guía de autoría requiere criterio contextual."},
  'FT-REVIEW-034': {"title": "Revisa los landmarks globales repetidos", "description": "Se han observado varios landmarks banner o contentinfo dentro del mismo ámbito documental. Comprueba si representan regiones globales ambiguas o contextos independientes válidos."},
  'FT-REVIEW-035': {"title": "Contenido fuera de las regiones de navegación", "description": "Se ha observado contenido fuera de las regiones landmark. Revisa si la organización de la página permite encontrarlo mediante navegación por regiones."},
  'FT-REVIEW-036': {"title": "Revisa el uso de encabezados en la tabla", "description": "Revisa si los encabezados de fila y columna describen correctamente las celdas y si la tabla es de datos o de presentación. La estructura necesita valoración contextual."},
  'FT-REVIEW-037': {"title": "Revisa el nombre y la descripción de la tabla", "description": "Revisa el nombre de la tabla y sus mecanismos de descripción para comprobar que identifican su propósito sin información repetida o contradictoria."},
  'FT-REVIEW-038': {"title": "Revisa si los marcos con el mismo nombre tienen un propósito equivalente", "description": "Varios marcos expuestos comparten nombre accesible. Comprueba si tienen un propósito equivalente; en caso contrario, asigna a cada uno un nombre que permita distinguirlo."},
  'FT-REVIEW-039': {"title": "No se ha evaluado un contexto de auditoría anidado", "description": "FocusTrace ha alcanzado un límite de auditoría anidada que no ha podido recorrer por completo. El contenido de un Shadow DOM cerrado, los descendientes de marcos inaccesibles y el contenido que supera el límite compartido de recorrido no deben considerarse libres de problemas."},
  'FT-REVIEW-040': {"title": "Revisa las etiquetas, agrupaciones e instrucciones del formulario", "description": "FocusTrace ha observado una señal de etiquetado, agrupación, instrucciones u obligatoriedad que requiere revisión humana. Esta regla no inspecciona ni conserva los valores editables de los campos."},
  'FT-REVIEW-041': {"title": "El viewport puede limitar niveles de ampliación superiores", "description": "La configuración permite ampliar al 200 %, pero puede limitar ampliaciones mayores. Revisa el comportamiento efectivo del navegador y las necesidades de ampliación del contenido."},
  'FT-REVIEW-042': {"title": "La página puede limitar el uso a una orientación de pantalla", "description": "Se ha observado una transformación condicionada por la orientación que puede restringir el uso de la página. Revisa las excepciones esenciales y los mecanismos alternativos antes de determinar un incumplimiento."},
  'FT-REVIEW-043': {"title": "La región desplazable puede no ser accesible mediante teclado", "description": "FocusTrace ha observado una región desplazable renderizada sin un punto de entrada al foco secuencial. Comprueba si puede enfocarse y recorrerse con teclado o si existe otro mecanismo accesible equivalente."},
  'FT-REVIEW-044': {"title": "El audio automático puede necesitar un mecanismo para detenerlo o silenciarlo", "description": "Se ha observado contenido multimedia con reproducción automática, sin silenciar y que puede superar tres segundos sin controles nativos observables. Revisa la reproducción real, la presencia de audio y los controles personalizados antes de considerarlo un fallo WCAG."},
  'FT-WARN-024': {"title": "La región ARIA necesita un nombre accesible", "description": "La región declarada explícitamente no tiene un nombre accesible que permita distinguir su propósito. Se trata de un aviso de autoría ARIA."},
  'FT-WARN-025': {"title": "El encabezado de tabla está vacío", "description": "Se ha observado una celda de encabezado sin contenido accesible utilizable. Revisa su función y proporciona una identificación adecuada."},
  'FT-WARN-026': {"title": "Revisa el atributo scope de la tabla", "description": "El atributo scope no corresponde a un valor o contexto válido para la celda. Revisa las asociaciones de encabezados de fila y columna."},
  'FT-WARN-027': {"title": "Revisa las referencias headers de la tabla", "description": "El atributo headers contiene referencias que no resuelven a encabezados válidos de la misma tabla. Revisa los identificadores y las relaciones indicadas."},
  'FT-WARN-028': {"title": "El mismo atajo accesskey está asignado a varios elementos", "description": "El mismo valor accesskey válido aparece en varios elementos del documento. Elimina la colisión para evitar que el navegador o la plataforma resuelvan el atajo de forma ambigua."},
  'FT-WARN-008': {
