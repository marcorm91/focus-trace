...
export function ScanView({
  ...
  return (
    <section className={`panel${componentScope ? ' component-scan-panel' : ''}`} aria-labelledby="scan-title">
      ...
      {!componentScope && scan.textResize && (
