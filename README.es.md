...
| **Trace** | Interacción real | Registra teclado/puntero, foco, cambios no sensibles de controles, mutaciones relevantes, rutas SPA, diálogos, candidatos a mensajes de estado, widgets ARIA y evidencia de causalidad/cambios de contexto. Iniciar/reanudar Trace o Focus Walk comprueba el sitio de la pestaña seleccionada frente a los sitios de la auditoría activa antes de grabar. | Eventos correlacionados por interacción; el seguimiento de cambios de contexto no conserva valores de controles. |
