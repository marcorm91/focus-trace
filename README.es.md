...
Para `FT-REVIEW-017` y `FT-REVIEW-018`, FocusTrace evalúa únicamente evidencia acotada de medios nativos. Las señales claras de contenido live/stream se excluyen. En audio puede observar alternativas candidatas locales, pero no demostrar su equivalencia; en vídeo puede observar pistas de captions, pero los subtítulos incrustados, los reproductores personalizados, la aplicabilidad por presencia de audio y la sincronización, exactitud o completitud siguen siendo manuales. `FT-REVIEW-017` cubre actualmente el subconjunto de solo audio de WCAG 1.2.1, no su rama de solo vídeo.
