...
La verificación de fondos sigue limitada a 100 candidatos de contraste por análisis y a 2.500 observaciones de estilo computado compartidas por esa pasada de verificación. Reutiliza estilos ya calculados y no recorre todas las reglas/seletores de las hojas CSS para cada candidato. Si se agota cualquiera de los límites, los candidatos restantes quedan explícitamente como REVIEW porque su fondo no se ha verificado, con el motivo de agotamiento y contadores coherentes. Los colores RGB opacos (incluidos negro y rojo) se distinguen de los colores RGBA transparentes.
