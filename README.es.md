...
| **PDF / TXT / Markdown / JSON** | Informe actual o línea base de Memory | Exporta la evidencia y las notas del auditor aplicables reutilizando los datos disponibles sin volver a recorrer silenciosamente todo el DOM. Los PDF individuales de página/componente incluyen un índice enlazado compacto con la tipografía normal, líneas de puntos y espaciado del índice multipágina, sin separadores sólidos entre filas. | Artefactos compartibles. |
