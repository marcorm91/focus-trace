...
test('Playwright adapter scans page and component checkpoints with the production engine', async ({ page }) => {
...
test('Playwright regression baseline survives same-route navigation and flags only the new FAIL', async ({ page }) => {
